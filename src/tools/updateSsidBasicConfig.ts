...
const updateSsidBasicConfigSchema = z.object({
    ...
    broadcast: z.boolean().describe('Whether to broadcast the SSID name'),
    guestNetEnable: z.boolean().describe('Whether this is a guest network'),
    vlanEnable: z.boolean().describe('Whether VLAN tagging is enabled'),
    mloEnable: z.boolean().describe('Whether MLO (Multi-Link Operation) is enabled'),
