...
const updateSsidHotspotV2Schema = z.object({
    ...
    hotspotV2Enable: coercedBoolean().describe('Whether Hotspot 2.0 (Passpoint) is enabled'),
    networkType: z.coerce
        .number()
        .int()
        .optional()
        .describe(
    ...
    dgafDisable: coercedBoolean().optional().describe('Whether to disable downstream group-addressed forwarding (blocks multicast/broadcast)'),
    internet: coercedBoolean().optional().describe('Whether internet access is available through this network'),
    availabilityIpv4: z.coerce
        .number()
        .int()
        .optional()
        .describe('IPv4 availability: 0=unavailable, 1=public, 2=port-restricted, 3=single NAT, 4=double NAT, 7=unknown'),
    availabilityIpv6: z.coerce.number().int().optional().describe('IPv6 availability: 0=unavailable, 1=available, 2=unknown'),
