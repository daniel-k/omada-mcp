...
import { registerDeleteAlertLogsTool } from './deleteAlertLogs.js';
import { registerDeleteEventLogsTool } from './deleteEventLogs.js';
...
import { registerExportLogsTool } from './exportLogs.js';
import { registerGenericApiCallTool } from './genericApiCall.js';
import { registerGetAlertLogsTool } from './getAlertLogs.js';
...
import { registerGetAuditLogsTool } from './getAuditLogs.js';
import { registerGetAuditNotificationSettingsTool } from './getAuditNotificationSettings.js';
...
import { registerGetEventLogsTool } from './getEventLogs.js';
...
import { registerGetLogNotificationSettingsTool } from './getLogNotificationSettings.js';
...
import { registerResetLogNotificationSettingsTool } from './resetLogNotificationSettings.js';
import { registerResolveAlertLogsTool } from './resolveAlertLogs.js';
...
import { registerUpdateAuditNotificationSettingsTool } from './updateAuditNotificationSettings.js';
...
import { registerUpdateLogNotificationSettingsTool } from './updateLogNotificationSettings.js';
...
export function registerAllTools(server: McpServer, client: OmadaClient): void {
    ...
    // Log tools (event/alert/audit logs and notification configuration)
    registerGetEventLogsTool(server, client);
    registerGetAlertLogsTool(server, client);
    registerGetAuditLogsTool(server, client);
    registerResolveAlertLogsTool(server, client);
    registerDeleteEventLogsTool(server, client);
    registerDeleteAlertLogsTool(server, client);
    registerExportLogsTool(server, client);
    registerGetLogNotificationSettingsTool(server, client);
    registerUpdateLogNotificationSettingsTool(server, client);
    registerResetLogNotificationSettingsTool(server, client);
    registerGetAuditNotificationSettingsTool(server, client);
    registerUpdateAuditNotificationSettingsTool(server, client);
